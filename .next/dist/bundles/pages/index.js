...
var external__react_popover_ = __webpack_require__(9);
  ...
  pages__createClass(GenerationUI, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(
        ...
        external__react__default.a.createElement(style__default.a, {
          styleId: '886648584',
          css: ['.copy.jsx-886648584{text-align:center;font-size:1.3em;margin-bottom:.5em;}', '.generation.jsx-886648584{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;width:100%;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}', '.input-range{width:80%;max-width:500px;}', '.button.jsx-886648584{margin-top:.5em;border-radius:.25em;cursor:pointer;font-weight:bold;text-decoration:none;color:#fff;position:relative;display:inline-block;-webkit-transition:all .25s;transition:all .25s;padding:5px 10px;font-size:1.4em;}', '.button.jsx-886648584:active{-webkit-transform:translate(0px,5px);-ms-transform:translate(0px,5px);transform:translate(0px,5px);box-shadow:0 1px 0 0;}', '.button.jsx-886648584{background-color:' + backGroundBlue + ';box-shadow:0 2px 4px 0 ' + external__color__default()(backGroundBlue).darken(0.5).hsl().string() + ';display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}', '.button.jsx-886648584:hover{background-color:' + external__color__default()(backGroundBlue).lighten(0.2).hsl().string() + ';}']
        })
      );
    }
  }]);
...
var pages_Cell = function Cell(props) {
  ...
  return external__react__default.a.createElement(
    'div',
    { onClick: onClick, className: 'jsx-' + CellStyle.__scopedHash + ' ' + style__default.a.dynamic([['60311025', [backgroundColor || 'initial', fontColor || 'initial']]]) + ' ' + 'cell'
    },
    notes ? range(9).map(function (i) {
      return external__react__default.a.createElement(
        'div',
        { key: i, className: 'jsx-' + CellStyle.__scopedHash + ' ' + style__default.a.dynamic([['60311025', [backgroundColor || 'initial', fontColor || 'initial']]]) + ' ' + 'note-number'
        },
        notes.has(i + 1) && i + 1
      );
    }) : value && value,
